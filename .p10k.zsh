# Generated by Powerlevel10k configuration wizard on 2024-03-20 at 04:14 EET.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 04117.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 12h time, vertical separators, slanted heads, blurred tails, 2 lines, disconnected,
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=#3EB489
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=238
  # Custom icon.
    typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='󰣭'
